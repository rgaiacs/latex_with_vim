...
\begin{document}
\title[Introdução ao LaTeX - 03/04]{Cursos CAMECC \\ Introdução ao LaTeX para o Curso 29 \\ Licenciatura em Matemática \\ Aula 03}
...
\section{Equações numeradas}
\begin{frame}[fragile]
    \frametitle{Equações numeradas (1)}
    \begin{code}
\documentclass{article}
\usepackage{amsmath}
\begin{document}
\begin{align}
    ...
    \label{eq:test}
\end{align}
Na equação \eqref{eq:test} \ldots
\end{document}
    \end{code}
\end{frame}

\begin{frame}[fragile]
    \frametitle{Equações numeradas (2)}
    \begin{code}
\documentclass{article}
\usepackage{amsmath}
\begin{document}
...
\begin{frame}[fragile]
    \frametitle{Alinhamento de equações}
    \begin{code}
\documentclass{article}
\usepackage{amsmath}
\begin{document}
\begin{align*}
    ...
    x &= 1
\end{align*}
% No lugar de \eqref{eq:test} irá aparecer (??).
Na equação \eqref{eq:test} \ldots
\end{document}
    \end{code}
\end{frame}

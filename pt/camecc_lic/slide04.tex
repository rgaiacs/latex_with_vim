...
\begin{document}
\title[Introdu\c{c}\~{a}o ao LaTeX - 04/04]{Cursos CAMECC \\ Introdu\c{c}\~{a}o ao LaTeX para o Curso 29 \\ Licenciatura em Matem\'{a}tica \\ Aula 04}
...
\begin{frame}[fragile]
    \frametitle{Gr\'{a}ficos de Fun\c{c}\~{o}es} 
    \begin{code}

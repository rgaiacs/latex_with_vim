...
\begin{document}
\title[Introdu\c{c}\~{a}o ao LaTeX - 02/04]{Cursos CAMECC \\ Introdu\c{c}\~{a}o ao LaTeX para o Curso 29 \\ Licenciatura em Matem\'{a}tica \\ Aula 02}
...
\section{Refer\^{e}ncia Cruzada}
\begin{frame}[fragile]
    \frametitle{Refer\^{e}ncia Cruzada} 
    \begin{code}
\documentclass{article}
\begin{document}
\begin{enumerate}
